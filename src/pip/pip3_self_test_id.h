...
typedef enum {
	...
	PIP3_SELF_TEST_ID_DEVICE_OFF_I2C_BUS       = 0x13,

	NUM_OF_PIP3_SELF_TEST_IDS = 20
} PIP3_Self_Test_ID;

extern char* PIP3_SELF_TEST_NAMES[NUM_OF_PIP3_SELF_TEST_IDS];

typedef enum {
	PIP3_DATA_FORMAT_ID_2BYTE_UNSIGNED            = 0x00,
	PIP3_DATA_FORMAT_ID_2BYTE_UNSIGNED_PLUS_EXTRA = 0x01,
	PIP3_DATA_FORMAT_ID_2BYTE_SIGNED              = 0x02,
